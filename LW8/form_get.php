<html>
  ...
  <body>
    <form method="post" action="get.php" class="get_form">
      <input type="email" name="email" placeholder="Email" class="your_email">
      <input type="submit" value="Получить данные" class="submit">
    </form>
  </body>
</html>